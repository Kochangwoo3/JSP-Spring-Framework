...
<ol>
	...
	<li>
		<a href="<%= request.getContextPath() %>/ch06/ex03.jsp">ex03.jsp get연습</a>
	</li>
	<li>
		<a href="<%= request.getContextPath() %>/ch06/ex04.jsp">ex04.jsp post연습</a>
	</li>
	<li>
		<a href="<%= request.getContextPath() %>/ch06/ex05.jsp">ex05.jsp - 같은이름 여러개요소</a>
	</li>
	<li>
	...
	<li>
		<a href="<%= request.getContextPath() %>/pcontrol?action=list">상품목록</a>
	</li>		
</ol>
